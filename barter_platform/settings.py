...
SECRET_KEY = 'django-insecure-u!3_zf!vlkv)lp292p163-asuhjd3ocotggluz5nq46kjtp^ap'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API для системы обмена вещами',
    'VERSION': '1.0.0',
}

REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticatedOrReadOnly',  # Только чтение для анонимов
    ],
...
DATABASES = {
    'default': {
        ...
        'NAME': '/app/db.sqlite3',  # Путь внутри контейнера
